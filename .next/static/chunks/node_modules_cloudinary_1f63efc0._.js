...
"[project]/node_modules/cloudinary/lib/utils/encoding/smart_escape.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
function smart_escape(string) {
    let unsafe = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : /([^a-zA-Z0-9_.\-\/:]+)/g;
...
"[project]/node_modules/cloudinary/lib/utils/parsing/consumeOption.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/utils/parsing/toArray.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const isArray = __turbopack_context__.r("[project]/node_modules/lodash/isArray.js [app-client] (ecmascript)");
/**
...
"[project]/node_modules/cloudinary/lib/utils/encoding/base64Encode.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/compiled/buffer/index.js [app-client] (ecmascript)");
function base64Encode(input) {
    if (!(input instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"])) {
        input = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(String(input), 'binary');
    }
    return input.toString('base64');
}
module.exports.base64Encode = base64Encode;
}}),
"[project]/node_modules/cloudinary/lib/utils/encoding/base64EncodeURL.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const { base64Encode } = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/encoding/base64Encode.js [app-client] (ecmascript)");
...
"[project]/node_modules/cloudinary/lib/utils/encoding/encodeDoubleArray.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const isArray = __turbopack_context__.r("[project]/node_modules/lodash/isArray.js [app-client] (ecmascript)");
const toArray = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/parsing/toArray.js [app-client] (ecmascript)");
/**
...
"[project]/node_modules/cloudinary/lib/utils/entries.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/config.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
const extend = __turbopack_context__.r("[project]/node_modules/lodash/extend.js [app-client] (ecmascript)");
...
const isUndefined = __turbopack_context__.r("[project]/node_modules/lodash/isUndefined.js [app-client] (ecmascript)");
const isEmpty = __turbopack_context__.r("[project]/node_modules/lodash/isEmpty.js [app-client] (ecmascript)");
const entries = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/entries.js [app-client] (ecmascript)");
...
function extendCloudinaryConfigFromQuery(ENV_URL) {
    let confToExtend = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    let uri = url.parse(ENV_URL, true);
    if (uri.query != null) {
        entries(uri.query).forEach((param)=>{
            let [key, value] = param;
...
function extendCloudinaryConfig(parsedConfig) {
    let confToExtend = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    entries(parsedConfig).forEach((param)=>{
        let [key, value] = param;
        if (value !== undefined) {
...
module.exports = function(new_config, new_value) {
    if (cloudinary_config == null || new_config === true) {
        ...
        let CLOUDINARY_ENV_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.CLOUDINARY_URL;
        let CLOUDINARY_ENV_ACCOUNT_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.CLOUDINARY_ACCOUNT_URL;
        let CLOUDINARY_API_PROXY = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.CLOUDINARY_API_PROXY;
...
"[project]/node_modules/cloudinary/lib/auth_token.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
const smart_escape = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/encoding/smart_escape.js [app-client] (ecmascript)");
const unsafe = /([ "#%&'/:;<=>?@[\]^`{|}~]+)/g;
function digest(message, key) {
    return crypto.createHmac("sha256", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(key, "hex")).update(message).digest('hex');
}
/**
...
"[project]/node_modules/cloudinary/lib/utils/utf8_encode.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/utils/crc32.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
const utf8_encode = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/utf8_encode.js [app-client] (ecmascript)");
/**
...
"[project]/node_modules/cloudinary/lib/utils/ensurePresenceOf.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/utils/ensureOption.js [app-client] (ecmascript)": ((__turbopack_context__) => {
 ...
 */ function defaults(defaultOptions) {
    return function ensureOption(options, name, defaultValue) {
        ...
        if (typeof options[name] !== 'undefined') {
            ...
            throw new Error("Must supply ".concat(name));
        }
        return value;
    };
}
...
"[project]/node_modules/cloudinary/lib/utils/isRemoteUrl.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/utils/analytics/getSDKVersions.js [app-client] (ecmascript)": ((__turbopack_context__) => {
 ...
 */ function getSDKVersions() {
    let useSDKVersion = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 'default', useNodeVersion = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'default';
    ...
    const version = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].version.slice(1);
...
"[project]/node_modules/cloudinary/lib/utils/analytics/removePatchFromSemver.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/utils/analytics/stringPad.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/utils/analytics/reverseVersion.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const stringPad = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/analytics/stringPad.js [app-client] (ecmascript)");
/**
...
"[project]/node_modules/cloudinary/lib/utils/encoding/base64Map.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/utils/analytics/encodeVersion.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const reverseVersion = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/analytics/reverseVersion.js [app-client] (ecmascript)");
const stringPad = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/analytics/stringPad.js [app-client] (ecmascript)");
const base64Map = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/encoding/base64Map.js [app-client] (ecmascript)");
/**
 * @private
...
"[project]/node_modules/cloudinary/lib/utils/analytics/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const removePatchFromSemver = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/analytics/removePatchFromSemver.js [app-client] (ecmascript)");
const encodeVersion = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/analytics/encodeVersion.js [app-client] (ecmascript)");
/**
 ...
 */ function getSDKAnalyticsSignature() {
    let analyticsOptions = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    try {
...
"[project]/node_modules/cloudinary/lib/utils/consts.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
const urlParse = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/native-url/index.js [app-client] (ecmascript)").parse;
// Functions used internally
const compact = __turbopack_context__.r("[project]/node_modules/lodash/compact.js [app-client] (ecmascript)");
const first = __turbopack_context__.r("[project]/node_modules/lodash/first.js [app-client] (ecmascript)");
const isFunction = __turbopack_context__.r("[project]/node_modules/lodash/isFunction.js [app-client] (ecmascript)");
const isPlainObject = __turbopack_context__.r("[project]/node_modules/lodash/isPlainObject.js [app-client] (ecmascript)");
const last = __turbopack_context__.r("[project]/node_modules/lodash/last.js [app-client] (ecmascript)");
const map = __turbopack_context__.r("[project]/node_modules/lodash/map.js [app-client] (ecmascript)");
const take = __turbopack_context__.r("[project]/node_modules/lodash/take.js [app-client] (ecmascript)");
const at = __turbopack_context__.r("[project]/node_modules/lodash/at.js [app-client] (ecmascript)");
// Exposed by the module
const clone = __turbopack_context__.r("[project]/node_modules/lodash/clone.js [app-client] (ecmascript)");
const extend = __turbopack_context__.r("[project]/node_modules/lodash/extend.js [app-client] (ecmascript)");
const filter = __turbopack_context__.r("[project]/node_modules/lodash/filter.js [app-client] (ecmascript)");
const includes = __turbopack_context__.r("[project]/node_modules/lodash/includes.js [app-client] (ecmascript)");
const isArray = __turbopack_context__.r("[project]/node_modules/lodash/isArray.js [app-client] (ecmascript)");
const isEmpty = __turbopack_context__.r("[project]/node_modules/lodash/isEmpty.js [app-client] (ecmascript)");
...
const isUndefined = __turbopack_context__.r("[project]/node_modules/lodash/isUndefined.js [app-client] (ecmascript)");
const smart_escape = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/encoding/smart_escape.js [app-client] (ecmascript)");
const consumeOption = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/parsing/consumeOption.js [app-client] (ecmascript)");
const toArray = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/parsing/toArray.js [app-client] (ecmascript)");
let { base64EncodeURL } = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/encoding/base64EncodeURL.js [app-client] (ecmascript)");
const encodeDoubleArray = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/encoding/encodeDoubleArray.js [app-client] (ecmascript)");
const config = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/config.js [app-client] (ecmascript)");
const generate_token = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/auth_token.js [app-client] (ecmascript)");
const crc32 = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/crc32.js [app-client] (ecmascript)");
const ensurePresenceOf = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/ensurePresenceOf.js [app-client] (ecmascript)");
const ensureOption = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/ensureOption.js [app-client] (ecmascript)").defaults(config());
const entries = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/entries.js [app-client] (ecmascript)");
const isRemoteUrl = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/isRemoteUrl.js [app-client] (ecmascript)");
const getSDKVersions = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/analytics/getSDKVersions.js [app-client] (ecmascript)");
const { getAnalyticsOptions, getSDKAnalyticsSignature } = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/analytics/index.js [app-client] (ecmascript)");
...
exports.USER_AGENT = "CloudinaryNodeJS/".concat(exports.VERSION, " (Node ").concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].versions.node, ")");
// Add platform information to the USER_AGENT header
// This is intended for platform information and not individual applications!
exports.userPlatform = "";
function getUserAgent() {
    return isEmpty(utils.userPlatform) ? "".concat(utils.USER_AGENT) : "".concat(utils.userPlatform, " ").concat(utils.USER_AGENT);
}
const { DEFAULT_RESPONSIVE_WIDTH_TRANSFORMATION, DEFAULT_POSTER_OPTIONS, DEFAULT_VIDEO_SOURCE_TYPES, CONDITIONAL_OPERATORS, PREDEFINED_VARS, LAYER_KEYWORD_PARAMS, TRANSFORMATION_PARAMS, SIMPLE_PARAMS, UPLOAD_PREFIX, SUPPORTED_SIGNATURE_ALGORITHMS, DEFAULT_SIGNATURE_ALGORITHM } = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/consts.js [app-client] (ecmascript)");
 ...
 */ function normalize_expression(expression) {
    ...
    const predefinedVarsPattern = "(" + Object.keys(PREDEFINED_VARS).map((v)=>":".concat(v, "|").concat(v)).join("|") + ")";
    const userVariablePattern = '(\\$_*[^_ ]+)';
    const variablesReplaceRE = new RegExp("".concat(userVariablePattern, "|").concat(predefinedVarsPattern), "g");
 ...
 */ function process_custom_pre_function(customPreFunction) {
    ...
    return utils.isString(result) ? "pre:".concat(result) : null;
}
/**
 * Parse "if" parameter
...
function replaceAllSubstrings(string, search) {
    let replacement = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : '';
 ...
 */ function encode_context(metadataObj) {
    ...
    return entries(metadataObj).map((param)=>{
        let [key, value] = param;
        // if string, simply parse the value and move on
        if (isString(value)) {
            return "".concat(key, "=").concat(escapeMetadataValue(value));
        // If array, parse each item individually
        } else if (isArray(value)) {
            let values = value.map((innerVal)=>{
                return '"'.concat(escapeMetadataValue(innerVal), '"');
            }).join(',');
            return "".concat(key, "=[").concat(values, "]");
        // if number, convert to string
        } else if (Number.isInteger(value)) {
            return "".concat(key, "=").concat(escapeMetadataValue(String(value)));
 ...
 */ function build_custom_headers(headers) {
    switch(true){
        ...
        case isObject(headers):
            return entries(headers).map((param)=>{
                let [k, v] = param;
                return "".concat(k, ":").concat(v);
            }).join("\n");
        default:
...
function generate_transformation_string(options) {
    ...
    if (isArray(effect)) {
        ...
        effect = entries(effect).map((param)=>{
            let [key, value] = param;
    ...
    SIMPLE_PARAMS.forEach((param)=>{
        let [name, short] = param;
    ...
    let variables = entries(options).filter((param)=>{
        let [key, value] = param;
    ...
    }).sort().concat(variablesParam.map((param)=>{
        let [name, value] = param;
        return "".concat(name, "_").concat(normalize_expression(value));
    })).join(',');
    let transformations = entries(params).filter((param)=>{
        let [key, value] = param;
...
function base_api_url(api_version) {
    ...
    return function() {
        let path = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [], options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [];
...
function api_url() {
    let action = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 'upload', options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
function signed_preloaded_image(result) {
    return "".concat(result.resource_type, "/upload/v").concat(result.version, "/").concat(filter([
        result.public_id,
        result.format
    ], utils.present).join("."), "#").concat(result.signature);
}
...
function api_string_to_sign(params_to_sign) {
    let signature_version = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 2;
    let params = entries(params_to_sign).map((param)=>{
        let [k, v] = param;
        return [
            String(k),
    ...
    let paramStrings = params.map((param)=>{
        let [k, v] = param;
        const paramString = "".concat(k, "=").concat(v);
 ...
 */ function api_sign_request(params_to_sign, api_secret) {
    let signature_algorithm = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, signature_version = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : null;
 ...
 */ function compute_hash(input, signature_algorithm, encoding) {
    if (!SUPPORTED_SIGNATURE_ALGORITHMS.includes(signature_algorithm)) {
        throw new Error("Signature algorithm ".concat(signature_algorithm, " is not supported. Supported algorithms: ").concat(SUPPORTED_SIGNATURE_ALGORITHMS.join(', ')));
    }
    const hash = crypto.createHash(signature_algorithm).update(input).digest();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(hash).toString(encoding);
}
function clear_blank(hash) {
    let filtered_hash = {};
    entries(hash).filter((param)=>{
        let [k, v] = param;
 ...
 */ function verifyNotificationSignature(body, timestamp, signature) {
    let valid_for = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 7200;
...
const OFFSET_ANY_PATTERN = "(".concat(NUMBER_PATTERN, ")([%pP])?");
const RANGE_VALUE_RE = RegExp("^".concat(OFFSET_ANY_PATTERN, "$"));
const OFFSET_ANY_PATTERN_RE = RegExp("(".concat(OFFSET_ANY_PATTERN, ")\\.\\.(").concat(OFFSET_ANY_PATTERN, ")"));
...
exports.create_source_tag = function create_source_tag(src, source_type) {
    let codecs = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null;
    let video_type = source_type === 'ogv' ? 'ogg' : source_type;
    let mime_type = "video/".concat(video_type);
    if (!isEmpty(codecs)) {
        let codecs_str = isArray(codecs) ? codecs.join(', ') : codecs;
        mime_type += "; codecs=".concat(codecs_str);
    }
    return "<source ".concat(utils.html_attrs({
        src,
        type: mime_type
    }), ">");
};
...
function hashToParameters(hash) {
    return entries(hash).reduce((parameters, param)=>{
        let [key, value] = param;
        if (isArray(value)) {
 ...
 */ function hashToQuery(hash) {
    return hashToParameters(hash).map((param)=>{
        let [key, value] = param;
...
"[project]/node_modules/cloudinary/lib/api_client/execute_request.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/compiled/buffer/index.js [app-client] (ecmascript)");
const config = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/config.js [app-client] (ecmascript)");
const https = /^http:/.test(config().upload_prefix) ? __turbopack_context__.r("[project]/node_modules/next/dist/compiled/stream-http/index.js [app-client] (ecmascript)") : __turbopack_context__.r("[project]/node_modules/next/dist/compiled/https-browserify/index.js [app-client] (ecmascript)");
const querystring = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/querystring-es3/index.js [app-client] (ecmascript)");
const Q = __turbopack_context__.r("[project]/node_modules/q/q.js [app-client] (ecmascript)");
const url = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/native-url/index.js [app-client] (ecmascript)");
const utils = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
const ensureOption = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/ensureOption.js [app-client] (ecmascript)").defaults(config());
...
function execute_request(method, params, auth, api_url, callback) {
    ...
    if (method !== "GET") {
        request_options.headers['Content-Length'] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].byteLength(query_params);
    }
...
"[project]/node_modules/cloudinary/lib/api_client/call_api.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
const utils = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
const ensureOption = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/ensureOption.js [app-client] (ecmascript)").defaults(config());
const execute_request = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/api_client/execute_request.js [app-client] (ecmascript)");
...
"[project]/node_modules/cloudinary/lib/api.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const utils = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
const call_api = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/api_client/call_api.js [app-client] (ecmascript)");
...
exports.delete_backed_up_assets = function(assetId, versionIds, callback) {
    let options = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
...
const deleteBackupParams = function() {
    let versionIds = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
    return {
...
const createRelationParams = function() {
    let publicIds = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
    return {
...
const deleteRelationParams = function() {
    let publicIds = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
    return {
...
exports.rename_folder = function rename_folder(old_path, new_path, callback) {
    let options = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
    let uri;
    uri = [
        'folders',
...
"[project]/node_modules/cloudinary/lib/v2/api.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const api = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/api.js [app-client] (ecmascript)");
const v1_adapters = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)").v1_adapters;
...
"[project]/node_modules/cloudinary/lib/cache.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
const { ensurePresenceOf, generate_transformation_string } = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
/**
...
Object.defineProperty(Cache, "instance", {
    get () {
        return ("TURBOPACK ident replacement", globalThis)[CACHE];
    }
});
Object.defineProperty(Cache, "adapter", {
   ...
   * @return {CacheAdapter} The current cache adapter
   */ get () {
        return ("TURBOPACK ident replacement", globalThis)[CACHE_ADAPTER];
    },
    /**
   * Set the cache adapter to be used by Cache
   * @param {CacheAdapter} adapter Cache adapter
   */ set (adapter) {
        ("TURBOPACK ident replacement", globalThis)[CACHE_ADAPTER] = adapter;
    }
});
Object.freeze(Cache);
// Instantiate the singleton
let symbols = Object.getOwnPropertySymbols(("TURBOPACK ident replacement", globalThis));
if (symbols.indexOf(CACHE) < 0) {
    ("TURBOPACK ident replacement", globalThis)[CACHE] = Cache;
}
/**
...
"[project]/node_modules/cloudinary/lib/upload_stream.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
class UploadStream extends Transform {
    ...
    _flush(next) {
        ...
        this.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from("--" + this.boundary + "--", 'ascii'));
        return next();
    }
    constructor(options){
        super();
...
"[project]/node_modules/cloudinary/lib/uploader.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
const { extname, basename } = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/path-browserify/index.js [app-client] (ecmascript)");
const Q = __turbopack_context__.r("[project]/node_modules/q/q.js [app-client] (ecmascript)");
const Writable = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/stream-browserify/index.js [app-client] (ecmascript)").Writable;
const urlLib = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/native-url/index.js [app-client] (ecmascript)");
// eslint-disable-next-line import/order
const { upload_prefix } = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/config.js [app-client] (ecmascript)")();
const isSecure = !(upload_prefix && upload_prefix.slice(0, 5) === 'http:');
const https = isSecure ? __turbopack_context__.r("[project]/node_modules/next/dist/compiled/https-browserify/index.js [app-client] (ecmascript)") : __turbopack_context__.r("[project]/node_modules/next/dist/compiled/stream-http/index.js [app-client] (ecmascript)");
const Cache = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/cache.js [app-client] (ecmascript)");
const utils = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
const UploadStream = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/upload_stream.js [app-client] (ecmascript)");
const config = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/config.js [app-client] (ecmascript)");
const ensureOption = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/ensureOption.js [app-client] (ecmascript)").defaults(config());
const agent = config.api_proxy ? new https.Agent(config.api_proxy) : null;
        ...
        if (this.buffer.length + data.length <= this.chunk_size) {
            ...
            this.emit('ready', this.buffer, false, (active)=>{
                ...
                if (this.active) {
                    ...
                    this.buffer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].alloc(0); // Reset the buffer
...
exports.create_archive = function create_archive(callback) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, target_format = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null;
 ...
 */ exports.add_tag = function add_tag(tag) {
    let public_ids = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], callback = arguments.length > 2 ? arguments[2] : void 0, options = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
...
exports.remove_all_tags = function remove_all_tags() {
    let public_ids = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [], callback = arguments.length > 1 ? arguments[1] : void 0, options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
...
function call_tags_api(tag, command) {
    let public_ids = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [], callback = arguments.length > 3 ? arguments[3] : void 0, options = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : {};
 ...
 */ function cacheResults(result, param) {
    let { type, resource_type } = param;
    if (result.responsive_breakpoints) {
        result.responsive_breakpoints.forEach((param)=>{
            let { transformation, url, breakpoints } = param;
...
function call_api(action, callback, options, get_params) {
    ...
    let post_data = utils.hashToParameters(params).filter((param)=>{
        let [key, value] = param;
        return value != null;
    }).map((param)=>{
        let [key, value] = param;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(encodeFieldPart(boundary, key, value), 'utf8');
    });
...
function post(url, post_data, boundary, file, callback, options) {
    let file_header;
    let finish_buffer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from("--" + boundary + "--", 'ascii');
    ...
    if (file != null || options.stream) {
        ...
        file_header = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(encodeFilePart(boundary, 'application/octet-stream', 'file', filename), 'binary');
    }
    ...
    if (oauth_token != null) {
        headers.Authorization = "Bearer ".concat(oauth_token);
    }
...
"[project]/node_modules/cloudinary/lib/v2/uploader.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const uploader = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/uploader.js [app-client] (ecmascript)");
const v1_adapters = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)").v1_adapters;
...
"[project]/node_modules/cloudinary/lib/v2/search.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const api = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/v2/api.js [app-client] (ecmascript)");
const config = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/config.js [app-client] (ecmascript)");
const { isEmpty, isNumber, compute_hash, build_distribution_domain, clear_blank, sort_object_by_key } = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
const { base64Encode } = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/encoding/base64Encode.js [app-client] (ecmascript)");
const Search = class Search {
    ...
    static sort_by(field_name) {
        let dir = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'asc';
    ...
    sort_by(field_name) {
        let dir = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "desc";
        let sort_bucket;
        sort_bucket = {};
    ...
    to_url(ttl, next_cursor) {
        ...
        const signature = compute_hash("".concat(urlTtl).concat(encodedQuery).concat(apiSecret), 'sha256', 'hex');
        const urlWithoutCursor = "".concat(urlPrefix, "/search/").concat(signature, "/").concat(urlTtl, "/").concat(encodedQuery);
...
"[project]/node_modules/cloudinary/lib/v2/search_folders.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const Search = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/v2/search.js [app-client] (ecmascript)");
const api = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/v2/api.js [app-client] (ecmascript)");
...
"[project]/node_modules/cloudinary/lib/v2/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const v1 = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/cloudinary.js [app-client] (ecmascript)");
const api = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/v2/api.js [app-client] (ecmascript)");
const uploader = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/v2/uploader.js [app-client] (ecmascript)");
const search = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/v2/search.js [app-client] (ecmascript)");
const search_folders = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/v2/search_folders.js [app-client] (ecmascript)");
const v2 = {
    ...v1,
    api,
    uploader,
...
"[project]/node_modules/cloudinary/lib/api_client/call_analysis_api.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/analysis/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const utils = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
const { call_analysis_api } = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/api_client/call_analysis_api.js [app-client] (ecmascript)");
function analyze_uri(uri, analysis_type) {
...
"[project]/node_modules/cloudinary/lib/api_client/call_account_api.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/provisioning/account.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const utils = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
const call_account_api = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/api_client/call_account_api.js [app-client] (ecmascript)");
 ...
 */ function sub_accounts(enabled) {
    let ids = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], prefix = arguments.length > 2 ? arguments[2] : void 0, options = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, callback = arguments.length > 4 ? arguments[4] : void 0;
    let params = {
        enabled,
        ids,
        prefix
 ...
 */ function sub_account(sub_account_id) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, callback = arguments.length > 2 ? arguments[2] : void 0;
    let uri = [
        'sub_accounts',
        sub_account_id
    ];
 ...
 */ function create_sub_account(name, cloud_name, custom_attributes, enabled, base_account) {
    let options = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : {}, callback = arguments.length > 6 ? arguments[6] : void 0;
    let params = {
 ...
 */ function users(pending, user_ids, prefix, sub_account_id) {
    let options = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : {}, callback = arguments.length > 5 ? arguments[5] : void 0;
    let uri = [
        'users'
    ];
    let params = {
 ...
 * @param [callback] {function}
 */ function access_keys(sub_account_id) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, callback = arguments.length > 2 ? arguments[2] : void 0;
 ...
 * @param [callback] {function}
 */ function generate_access_key(sub_account_id) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, callback = arguments.length > 2 ? arguments[2] : void 0;
    const params = pickOnlyExistingValues({
        name: options.name,
 ...
 * @param [callback] {function}
 */ function update_access_key(sub_account_id, api_key) {
    let options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, callback = arguments.length > 3 ? arguments[3] : void 0;
    const params = pickOnlyExistingValues({
        name: options.name,
        enabled: options.enabled
 ...
 * @param [callback] {function}
 */ function delete_access_key(sub_account_id, api_key) {
    let options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, callback = arguments.length > 3 ? arguments[3] : void 0;
    const uri = [
        'sub_accounts',
        sub_account_id,
 ...
 * @param [options] {object} - See {@link https://cloudinary.com/documentation/provisioning_api#tag/access-keys/DELETE/sub_accounts/{sub_account_id}/access_keys|delete access key optional parameters} in the SDK documentation.
 * @param [callback] {function}
 */ function delete_access_key_by_name(sub_account_id) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, callback = arguments.length > 2 ? arguments[2] : void 0;
    const params = {
        name: options.name
    };
...
"[project]/node_modules/cloudinary/lib/preloaded_file.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
let PRELOADED_CLOUDINARY_PATH, config, utils;
utils = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
config = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/config.js [app-client] (ecmascript)");
...
"[project]/node_modules/cloudinary/lib/utils/generateBreakpoints.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/cloudinary/lib/utils/srcsetUtils.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const utils = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
const generateBreakpoints = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/generateBreakpoints.js [app-client] (ecmascript)");
const Cache = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/cache.js [app-client] (ecmascript)");
 ...
 */ function getOrGenerateBreakpoints(public_id) {
    let srcset = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    let breakpoints = [];
    if (srcset.useCache) {
 ...
 */ function generateSrcsetAttribute(public_id, breakpoints, transformation, options) {
    ...
    utils.patchFetchFormat(options);
    return breakpoints.map((width)=>"".concat(scaledUrl(public_id, width, transformation, options), " ").concat(width, "w")).join(', ');
}
/**
 ...
 */ function generateSizesAttribute() {
    ...
    return breakpoints.map((width)=>"(max-width: ".concat(width, "px) ").concat(width, "px")).join(', ');
}
/**
 ...
 */ function generateImageResponsiveAttributes(publicId) {
    let attributes = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, srcsetData = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, options = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
...
"[project]/node_modules/cloudinary/lib/cloudinary.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const _ = __turbopack_context__.r("[project]/node_modules/lodash/lodash.js [app-client] (ecmascript)");
exports.config = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/config.js [app-client] (ecmascript)");
exports.utils = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/index.js [app-client] (ecmascript)");
exports.uploader = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/uploader.js [app-client] (ecmascript)");
exports.api = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/api.js [app-client] (ecmascript)");
exports.analysis = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/analysis/index.js [app-client] (ecmascript)");
const account = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/provisioning/account.js [app-client] (ecmascript)");
exports.provisioning = {
    account: account
};
exports.PreloadedFile = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/preloaded_file.js [app-client] (ecmascript)");
exports.Cache = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/cache.js [app-client] (ecmascript)");
...
const { generateImageResponsiveAttributes, generateMediaAttr } = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/utils/srcsetUtils.js [app-client] (ecmascript)");
/**
 ...
 */ function chainTransformations(options) {
    let transformation = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [];
 ...
 */ exports.video = function video(public_id, options) {
    ...
    return "".concat(html).concat(fallback, "</video>");
};
/**
...
exports.v2 = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/v2/index.js [app-client] (ecmascript)");
}}),
"[project]/node_modules/cloudinary/cloudinary.js [app-client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
module.exports = __turbopack_context__.r("[project]/node_modules/cloudinary/lib/cloudinary.js [app-client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=node_modules_cloudinary_1f63efc0._.js.map